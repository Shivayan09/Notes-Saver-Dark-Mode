    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-row gap-7 justify-evenly w-[90vw] md:w-[60vw]'>
                ...
                />
                <button onClick={createPaste} className='bg-cyan-600 h-10 rounded-2xl ml-5 hover:cursor-pointer w-[32vw] md:w-[15vw] text-white'>
                    {
                        pasteId ? "Update Note" : "Create Note"
                    }
                </button>
            </div>
            <div className='text-black bg-white/50 shadow-2xl m-5 rounded-2xl h-[70vh] min-w-[50vw]'>
